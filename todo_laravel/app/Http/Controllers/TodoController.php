...
class TodoController extends Controller
{
    ...
    public function todo_save(Request $request)
    {
        ...
        $validator = Validator::make($request->all(),[
            // バリデーションルール
            'new_user_id' => 'required|integer',        // user id ユーザー入力しないはずのデータ
    ...
    public function todo_update(Request $request)
    {
        ...
        $validator = Validator::make($request->all(),[
            // バリデーションルール
            'edit_id' => 'required|integer',        // todo id ユーザー入力しないはずのデータ
            'edit_user_id' => 'required|integer',        // user id ユーザー入力しないはずのデータ
        ...
        [
            // エラーメッセージ
            'edit_id.required' => 'todo IDが入力されていません。',       //ユーザー入力しないはずのデータ
            'edit_id.integer' => 'todo IDが数値で入力されていません。',  //ユーザー入力しないはずのデータ
            'edit_user_id.required' => 'ユーザーIDが入力されていません。',       //ユーザー入力しないはずのデータ
            'edit_user_id.integer' => 'ユーザーIDが数値で入力されていません。',  //ユーザー入力しないはずのデータ
